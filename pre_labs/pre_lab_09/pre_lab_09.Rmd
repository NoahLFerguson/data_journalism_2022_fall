...
**Answer** I see precinct locations based on shape, area and length, among other factors.
...
**Answer** precinct locations based on shape, area and length, as well as districts
...
**Answer** It shows Prince George's county spatially, with every individual shape being a county precinct.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Looks like a very similar dataframe to the one above, with the addition of the geometry column at the bottom
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maryland ccounties with the FPS code and other descriptors
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map of the state of Maryland by county
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The same map of PG County, but the boundaries are more descriptive and accurate based on the number of boundaries
...
**Task** Run the following code. Describe the output in the space below.
**Answer**  Precinct data for Prince George's County by turnout
...
**Task** Run the following code. Describe the output in the space below.
**Answer** A combined data frame of PG County data and PG County precinct turnout
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Map of Prince George's County with color-coded precincts. A precinct with a higher turnout is a lighter color than a lower turnout, darker color precinct
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maryland counties with voter breakdown by party
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Population estimaes for each Maryland county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The same data frame with a new "geometry" column on the right.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maryland counties with voter breakdown by party once again.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maryland ounty with total population and geometry column
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Successful joined data frame with County, total population, voter breakdown by party and geometry column for the map.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Fixed the original data frame to accurately descrive St. Mary's and Baltimore County, whoch was incorrectly spelled in the previous data frame.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The number of voters per 10,000 population for each county, sorted from highest to lowest
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Map of Maryland by county with color-coded counties. A county with a higher turnout is a lighter color than a lower turnout, darker color county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Changed the color scheme on the new map, whoch made the highest ranking counties stand out more.
...
**Answer** Same map with better color scheme regarding minute differences between counties. It's interesting how spread out the counties are with higher voter turnout. They're not all packed in to one region of Maryland, but are pretty spread out across the state which is interesting.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Same data frame as before but with a new column regarding unaffiliated population per 10,000 people.
...
**Answer** Same mpa but with unaffiliated voters per 10k people. A lot of Maryland counties are right in the middle of the spectrum, while there's only one county with 900 unaffiliated voters or fewer per 10k people.
