...
**Answer** https://datawrapper.dwcdn.net/lUqyK/1/
...
```{r}
write_csv(md_gov_total, "data/md_gov_total.csv")
```
...
**Answer** The map went from the entire country to just the state of Maryland.
...
**Answer** When you hover over the counties in the map, they now read the county name and the percentage of Wes Moore votes in that county.
...
**Answer** Put the URL of your map here. https://datawrapper.dwcdn.net/HMnEK/1/
