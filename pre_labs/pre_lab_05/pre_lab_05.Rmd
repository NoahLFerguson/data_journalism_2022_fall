...
**Answer** There are a lot of duplicates with slightly different spellings (WALTERS SPORT vs. WALTERS vs. WALTERS SPORTS), which skews the contribution count. A lot of the values are extremely similar with slightly different spellings.
...
**Answer** 1. Added a comma to "Joe's Seafood Prime Steak & Stone Crab" to make it "Joe's Seafood, Prime Steak & Stone Crab" in the cleaned version. 2. Got rid of the duplicate "Le Diplomate" in the recipient_name column to make it just "Le Diplomate".
...
**Answer** 1. Added a period after "W. Millar and Co" in the second result. 2. Removed the "'" in "Walter's Sports Bar" in the tenth result. 3. Changed "Hilton Washington" to "Washington Hilton" in the 12th result.
...
**Answer** The changes aren't substantially different, but vary slightly. For example, "Walters Sports" becomes "Walters Sport" in the cleaned version of this data, unlike in the key_collision_merge version of the cleaned data above.
