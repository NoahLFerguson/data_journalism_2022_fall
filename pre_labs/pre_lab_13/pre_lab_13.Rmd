...
**Answer** The column names are wonky (Michael Anthony Peroutka  Republican) for example. The votes are also <chr> tags when they should be number tags.
...
**Answer** The numbers 2, 3 and 4 are referring to the second third and fourth columns (peroutka = 2, brown = 3, write_ins = 4)
...
**Answer** {xml_nodeset (57)} suggests that there are 57 tags in the HTML source
...
**Answer** The output is more of a list now, with the numbers in brackets but with a bunch of weird quotation marks and /n marks.
...
**Answer** It's now its own data set with numbered values, but we still have some unwanted rows that need to be trimmed up.
