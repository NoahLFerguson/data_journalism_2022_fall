...
**Answer** The datatypes are incorrect and there are rows with "NA's", and the column names are confusing and not representative.
...
**Answer* Tthere are still "NA's" in the data frame
...
**Answer** This frame has 665 rows compared to 734 rows in Task 6
