...
**Task** "d02ca188f0878d4314ebc4b1379d7aaa7e592844" (leave the quotemarks).

```{r echo=FALSE}
census_api_key("d02ca188f0878d4314ebc4b1379d7aaa7e592844", install=TRUE)
```
...
**Answer** Yes, the difference in the error bar length is significantly different despite the median being relatively similar.

Is the difference between Howard and everyone else significant?
**Answer** Yes, Howard's ACS estimate is significantky higher than the rest of the counties.
...
**Answer** I don't see any counties that had their median incomes fall from 2010-2020.
...
**Answer** What are the median household incomes of the zip codes directly surrounding the top zip codes. Are the zipcodes with the highest median household income surrounded by similarly high zip code neighbors? Or are there disparities between those zipcodes and the zipcodes next to them?