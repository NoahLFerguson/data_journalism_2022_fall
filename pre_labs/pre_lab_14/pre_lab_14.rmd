...
**Answer** The output of the dataframe is each Ben Cardin press release by date, website url, title and text
...
**Answer** It makes words that have differences in capitalization and punctuation unique even when they aren't.
...
**Answer** The output is each unique word of the press release in order of the wording of the release itself.
...
**Answer** The results are much more interesting, since important words like "health" and "support" and "funding" are now at the top instead of "the" and "and" and other non-important words in this context.
...
**Answer** The word "project" wasn't in the 2021 top ten but was the top word in 2022. Is there a new project that Cardin is pushing that they didn't push last year? Also,the word "covid" was prominent in 2021 but not in 2022, but the word "health" was toward the top of both lists.
...
**Task** Run the following code and describe the results.
**Answer** The bigram "covid 19" was the top result in the dataframe, and "19 pandemic" was also in the top five, which was interesting. Health is clearly very important, as in addition to COVID-19 is in multiple other top ten data points.
...
**Task** Run the following code and describe the results.
**Answer** COVID-19, while still high up, was usurped by "project location" for the top spot on the list.
...
**Answer** The data set characterizes each word in a positive or negative context. This is cool but can sometimes be counter-intuitive. For example, the word "trump" is marked as positive, probably because the computer doesn't think of the word trump as a last name. Cardin is a democratic senator, so many of the things he's saying about Donald Trump probably aren't positive, contrary to what the data says.
