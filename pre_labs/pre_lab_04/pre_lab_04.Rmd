...
**Answer**They each have the same column structure.
```{r}
...
**Answer** There are now 24 rows. There should be 25 rows, but the "total" row wasn't translated over since it wasn't an identical match when the data sets merged.
...
**Answer** I didn't receive an error when joining the data.
...
**Answer** Prince George's county has the highest 18+ Black population with just under 61% (60.9%) and the highest percentage of Democrats in that county with 78.2%
...
**Answer**Howard County has the highest percentage of 18+ Asian population with only 19%. This is a stark contrast to the Black population data, as Asian people don't have counties in Maryland where they are he majority race. Prince George's County has just a 4% asian population as opposed to a 60% Black population.
